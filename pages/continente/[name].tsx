...
export default function Continent() {
  ...
  return (
    <>
      ...
      <Flex maxW={1240} mx="auto" my="80px" px="15px" justify="space-between" flexWrap="wrap">
        <Text maxW={600} fontSize={["md", "xl"]} textAlign="justify" lineHeight="36px">
      ...
      <Box maxW={1240} mx="auto" mb={35}>
        ...
        <Flex flexWrap="wrap" justifyContent={isWideVersion ? 'space-between' : 'center'}>
          <Box bg="white" w={256} h={279} mx={4} mb={4} borderRadius="4px" border=" 1px solid rgba(255, 186, 8, 0.5);">
